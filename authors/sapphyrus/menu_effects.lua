...
local last_change = globals_realtime()
local x_dir, y_dir = "+", "+"
local x, y = 0, 0
local flags = "b"
local additional = 2
			...
			if contains(effects, "Dots") then
				...
				for i=1, #dots do
					...
					for i2=1, #dots do
						...
						if distance(x, y, x2, y2) <= dots_connect_distance then
							client_draw_line(ctx, x, y, x2, y2, r_connect, g_connect, b_connect, a_connect)
						end
					end
				end
